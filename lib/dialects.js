...
Dialects.prototype.call = function (dialect, arg) {
  ...
  case 'rpc':
    return new RpcCaller(dobj.instance, arg);
  case 'pubsub':
    return new PubSubCaller(this.qb, dobj.instance, arg);
  default:
...
Dialects.prototype._start = function () {
  ...
  _.each(this.spoken, function (dobj, dname) {
    ...
    if (dobj.pkg.type === 'rpc') {
      ...
      if (newtypes.length) {
        dobj.instance.can.apply(null, newtypes);
...
PubSubCaller.prototype.publish = function (message, callback) {
  ...
  this.c.publish(channel, message, callback);
...
RpcCaller.prototype.push = function (message, callback) {
  this.c.push(this.endpoint, message, callback);
  return this;
}