...
var default_options = {
  ...
  timeout: 1, //relyq-listener: Timeout (seconds) for blocking process calls of listeners for service tasks
  ...
  Q: relyq.RedisJsonQ, //qb: relyq Queue Type
  ...
  defer_interval: 1000, //relyq: interval between checking for deferred tasks
}
